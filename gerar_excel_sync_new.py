...
'''
    ...
    config_ws.cell(row=4, column=1, value="Intervalo de Sincronização (segundos)")
    config_ws.cell(row=4, column=2, value="30")
...
def gerar_relatorio():
    ...
    nome_arquivo = f"controle_ferramentas_{timestamp}.xlsm"
    ...
    print("4. A planilha irá sincronizar automaticamente a cada 30 segundos")
...
if __name__ == "__main__":
    ...
    # Opcional: Sincronizar com Google Sheets após gerar Excel
    try:
        ...
        # Sincronizar
        print("\nTentando sincronizar com Google Sheets...")
        ...
        if sucesso:
            print("Sincronização com Google Sheets concluída!")
        else:
            print("Falha na sincronização com Google Sheets, mas Excel foi gerado.")

    except ImportError:
        print("Módulo google_sheets_sync não encontrado. Pulando sincronização.")
    except Exception as e:
        print(f"Erro na sincronização com Google Sheets: {e}")
        print("Excel foi gerado, mas sincronização falhou.")
